...
void ajouteEnTete(liste* ,Element); // ajout d'un élément en tête de liste
...
void ajoutePos(liste* maListe,Element x,int pos ); // ajout d'un élément à la position désirée dans la liste
